  ...
  <div className="max-w-7xl mx-auto">
    <div className="relative bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl transition-all duration-300 hover:shadow-purple-500/20">
      ...
      <div className="relative">
        <div className="inline-block mb-4">
          <span className="text-sm text-purple-400 border border-purple-500/30 px-4 py-1.5 rounded-full backdrop-blur-sm bg-purple-500/10 font-medium">
            📅 Available in Hardcopy & Instant PDF
          </span>
        </div>

        <h3 className="text-2xl sm:text-4xl font-black mb-4 bg-gradient-to-r from-purple-400 via-indigo-400 to-blue-400 bg-clip-text text-transparent">
          PSSSB 90-Day Master Success Planner — Choose Your Format
        </h3>

        <p className="text-sm sm:text-base text-gray-300 mb-8 max-w-4xl leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div>
              <div className="flex justify-between items-center mb-3">
                <h4 className="text-lg font-bold text-white flex items-center gap-2">
                  📦 Option 1: Premium Printed Book
                </h4>
                <span className="bg-red-600/20 text-red-400 border border-red-500/30 text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Best Value</span>
              </div>
              <ul className="space-y-2.5 mb-4">
                {[
                  'Dispatched to your doorstep within 1–3 working days',
                  'Shipped via India Post or premium courier partners',
                  'Tracking ID shared directly to your email automatically',
                  'High-quality crisp binding pages for writing and tracking daily goals',
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-2 text-sm text-gray-300">
                    <span className="text-purple-400 mt-0.5 text-xs">●</span> {item}
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-600/10 to-cyan-600/10 rounded-2xl p-6 border border-blue-500/20 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-center mb-3">
                <h4 className="text-lg font-bold text-white flex items-center gap-2">
                  📥 Option 2: Printable Softcopy (PDF)
                </h4>
                <span className="bg-green-600/20 text-green-400 border border-green-500/30 text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Instant</span>
              </div>
              <ul className="space-y-2.5 mb-4">
                {[
                  'Instant delivery access link right after complete payment',
                  'Delivered straight onto your email address',
                  'Print friendly layout tailored beautifully for clean A4 configurations',
                  'Highly cost-effective alternative for immediate self-paced structure',
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-2 text-sm text-gray-300">
                    <span className="text-cyan-400 mt-0.5 text-xs">●</span> {item}
                  </li>
                ))}
              </ul>
            </div>
            <p className="text-xs text-cyan-300/80 italic font-medium pt-2 border-t border-white/5">Perfect for digital tablet notes or local self-printing shops.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-6 border-t border-white/10">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-400">Say goodbye to random studying. Choose the option that fits your preparation routine best.</p>
          </div>
          <button
            onClick={() => navigate('/psssb-90-day-master-planner')}
            className="w-full sm:w-auto px-8 py-4 rounded-2xl font-black text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 shadow-[0_0_20px_rgba(147,51,234,0.4)] transition-all duration-300 hover:-translate-y-1 active:scale-95 whitespace-nowrap"
          >
            Get Your Copy Now →
          </button>
        </div>
    ...
    <div className="relative bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl transition-all duration-300 hover:shadow-orange-500/20">
      ...
      <div className="relative">
        ...
        <div className="mb-6">
          ...
          <p className="text-lg text-orange-300 font-semibold">📅 Every Sunday • Google Meet  • Session  • 10am-11am</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-6 border-t border-white/10">
          <div>
            ...
            <p className="text-sm text-gray-400"> Live Session • Google Meet •Every Sunday</p>
          </div>
          <button
            onClick={() => navigate('/excise-inspector')}
            className="w-full cursor-pointer sm:w-auto px-8 py-4 rounded-2xl font-black text-white bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-500 hover:to-red-500 shadow-[0_0_20px_rgba(251,146,60,0.4)] transition-all duration-300 hover:-translate-y-1 active:scale-95"
          >
            Register Now →
          </button>
        </div>
