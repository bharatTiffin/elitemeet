  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Register for the Excise Inspector exam strategy session on 22nd March(Sunday). Complete roadmap to crack the exam with expert guidance." />
      </Helmet>
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              ...
              <span className="text-white font-semibold"> 22nd March •Sunday • Google Meet</span>
            </p>
          </div>
