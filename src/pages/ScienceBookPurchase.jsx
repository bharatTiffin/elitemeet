// src/pages/ScienceBookPurchase.jsx
...
function ScienceBookPurchase() {
  ...
  const [scienceInfo, setScienceInfo] = useState(null);
  ...
  const fetchScienceInfo = async () => {
    try {
      ...
      setScienceInfo({
        ...
        description: 'Complete PSSSB & Punjab Exams General Science Package covering Physics, Chemistry, Biology for scoring full marks',
        price: 199,
        originalPrice: 299,
        features: [
        ...
        highlights: [
          'Physics: Laws of Motion, Energy, Electricity & Magnetism',
          'Chemistry: Elements, Compounds, Chemical Reactions',
          'Biology: Human Body, Diseases, Genetics & Evolution',
          ...
          'Exam-focused numerical problems & concepts'
        ]
      });
    } finally {
      setLoading(false);
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      const options = {
        ...
        currency: 'INR',
        name: 'Elite Academy',
        description: 'Complete Science Package for PSSSB & Punjab Exams',
        order_id: order.id,
        handler: async function (razorpayResponse) {
          try {
            ...
            alert(
              ...
              'The Science Book PDF should be sent to your email shortly.\n' +
      ...
      console.error('Error creating science purchase:', error);
      alert(
      ...
      <div className="min-h-screen bg-black text-white py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-4 bg-gradient-to-r from-purple-400 via-pink-400 to-rose-400 bg-clip-text text-transparent">
          ...
          <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 border-2 border-purple-500 rounded-3xl p-8 text-center">
            ...
            <button
              ...
              disabled={processing}
              className="w-full md:w-auto px-12 py-4 bg-gradient-to-r from-purple-500 to-pink-600 text-white font-bold text-lg rounded-xl hover:from-purple-600 hover:to-pink-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed mb-6"
            >
              {processing ? 'Processing...' : '🎯 Buy Now - Get Instant Access'}
            </button>

            <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
              <p className="text-sm text-purple-300 mb-2">📧 After Payment</p>
              <p className="text-xs text-gray-300">
                The Science Book PDF will be sent to your email ({user?.email || 'your email'}) within 5 minutes after successful payment.
                Please check your inbox and spam folder.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              ...
              <p className="text-sm text-gray-400">Physics, Chemistry & Biology in 95 pages</p>
            </div>
            <div className="text-center p-6 bg-gray-900/50 rounded-2xl border border-gray-800">
              <div className="text-3xl mb-3">🔥</div>
          ...
          <p className="text-center text-gray-500 text-sm mt-12">
            ...
            <a href="mailto:2025eliteacademy@gmail.com" className="text-purple-400 hover:underline">
...
export default ScienceBookPurchase;
