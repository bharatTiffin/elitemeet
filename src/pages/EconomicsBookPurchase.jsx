...
function EconomicsBookPurchase() {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      const response = await booksAPI.createBookPurchase('economics', buyerDetails);
      ...
      const options = {
        ...
        handler: async function (razorpayResponse) {
          try {
            alert(
              "Payment successful! 🎉\n\n" +
              "The Economics Book PDF will be sent to your email (" + buyerDetails.userEmail + ") within 5 minutes.\n\n" +
              "✅ 85 Pages Full Economics Notes\n" +
              "✅ 18 Pages PYQs (2012–2025)\n\n" +
