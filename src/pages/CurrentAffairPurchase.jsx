...
function CurrentAffairPurchase() {
  ...
  const fetchPdfInfo = async () => {
    try {
      const response = await currentAffairAPI.getInfo();
      console.log('Current Affair info fetched:', response.data);
      setPdfInfo({
        ...response.data.pdf,
        originalPrice: response.data.pdf.price + 100 // Add original price for discount display
      });
    } catch (error) {
      console.error('Error fetching current affair info:', error);
      setPdfInfo({
        name: 'Elite Academy All current affairs 2024',
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      const options = {
        ...
        currency: 'INR',
        name: 'Elite Academy',
        description: 'Elite Academy Current Affairs Magazine',
        order_id: order.id,
        handler: async function (razorpayResponse) {
          try {
            alert(
              ...
              "🙏 100% proceeds go to Bhai Kanhaiya Ji Foundation\n\n" +
      ...
      console.error('Error creating current affair purchase:', error);
      alert(
      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-r from-orange-500 to-red-600 mb-4 sm:mb-6 shadow-lg shadow-orange-900/50">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-3 sm:mb-4">
              {'Elite Academy Current Affairs 2024'}
            </h1>
          ...
          {/* Noble Cause Banner */}
          <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 mb-8 sm:mb-12 border border-orange-500/50">
          ...
          <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden border border-gray-700">
            ...
            <div className="p-6 sm:p-8 md:p-12">
              ...
              <div className="inline-block px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-full text-sm font-semibold mb-6 sm:mb-8 shadow-lg">
                🎯 What's Inside ({pdfInfo?.totalPages} Pages)
              </div>
              ...
              {/* Key Highlights */}
              {pdfInfo?.highlights && pdfInfo.highlights.length > 0 && (
              ...
              <div className="bg-gradient-to-r from-blue-900/50 to-purple-900/50 rounded-xl sm:rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 border border-blue-700/50 shadow-lg">
                <div className="text-center">
                  <p className="text-base sm:text-lg text-orange-300 mb-2 font-semibold">
                    🎁 Special Charity Price
                  </p>
                  <div className="flex items-center justify-center space-x-3 mb-4">
                    {pdfInfo?.originalPrice && (
                  ...
                  <p className="text-blue-300 text-base sm:text-lg font-medium mb-6">
                    {pdfInfo?.callToAction || 'Join us in this beautiful cause'}
                  </p>
                </div>
              </div>
              ...
              >
                {processing ? (
                  ...
                  '🎯 Purchase Now & Support a Noble Cause'
                )}
              </button>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-blue-400 leading-relaxed">
                      The Current Affairs Magazine PDF will be sent to your email <strong className="text-white">({user?.email || 'your email'})</strong> within 5 minutes after successful payment.
                    </p>
          ...
          <div className="mt-8 sm:mt-12 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-12 border border-gray-700">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="text-center group">
                ...
                <p className="text-sm sm:text-base text-gray-400">All current affairs 2024 in {pdfInfo?.totalPages} pages comprehensive notes</p>
              </div>
              
              <div className="text-center group sm:col-span-2 md:col-span-1">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-orange-600 to-red-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-orange-900/50 group-hover:scale-110 transition-transform">
                  <span className="text-3xl sm:text-4xl">❤️</span>
                </div>
                <h4 className="font-bold text-base sm:text-lg mb-2 text-white">Noble Cause</h4>
                <p className="text-sm sm:text-base text-gray-400">100% proceeds support humanitarian work</p>
              </div>
            </div>
          </div>
...
export default CurrentAffairPurchase;