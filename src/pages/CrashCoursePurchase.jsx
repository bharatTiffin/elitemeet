              ...
              <div className="relative animate-in fade-in duration-500">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-12">
                  ...
                  <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 border-2 border-orange-500/50 rounded-3xl p-8 text-center hover:border-orange-400 transition-all">
                    ...
                    <div className="flex items-baseline justify-center gap-4 mb-6">
                      {/* <span className="text-4xl font-black text-orange-400">₹11,999</span> */}
                  ...
                  <form onSubmit={handleEnrollmentSubmit} className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input type="email" required name="email" value={formData.email} onChange={handleInputChange} className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3.5 focus:border-indigo-500 outline-none transition-all" placeholder="Enter your email" />
                      </div>
                      <div className="space-y-2">
